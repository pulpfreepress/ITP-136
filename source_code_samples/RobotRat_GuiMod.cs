...
/// </summary>
public class RobotRat : Form
{
    private FlowLayoutPanel panel_1 = null;
	...
	private void InitializeComponent(){
	  panel_1 = new FlowLayoutPanel();
	
	  button_1 = new Button();
	  button_1.Text = "Pen Up";
	  button_1.Click += SetPenUp;
	  
	  button_2 = new Button();
	  button_2.Text = "Print Floor";
	  button_2.Click += PrintFloor;
	  
	  
	  panel_1.Controls.Add(button_1);
	  panel_1.Controls.Add(button_2);
	  this.Controls.Add(panel_1);
	  this.Text = "RobotRat Control Panel";
	}
    ...
    /// </summary>
    public void SetPenUp(Object sender, EventArgs e)
    {
    ...
    /// </summary>
    public void PrintFloor(Object sender, EventArgs e)
    {
            ...
            case PenPositions.UP: switch (direction)
                {
                    ...
                    case Directions.SOUTH:
                        if ((current_row + spaces_to_move) > (floor.GetLength(1) - 1))
                        {
                    ...
                    case Directions.EAST:
                        if ((current_col + spaces_to_move) > (floor.GetLength(0) - 1))
                        {
